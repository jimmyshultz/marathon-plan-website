  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-3xl text-black font-bold mb-8">Privacy Policy</h1>
        
        <div className="bg-white shadow-md rounded-lg p-8 mb-8">
          <div className="prose max-w-none">
            <p className="mb-4 text-black">Last updated: {new Date().toLocaleDateString()}</p>
            
            <h2 className="text-xl text-black font-semibold mt-6 mb-3">Introduction</h2>
            ...
            <h2 className="text-xl text-black font-semibold mt-6 mb-3">How We Use Your Data</h2>
            <p className="mb-4 text-black">
            ...
            <h2 className="text-xl text-black font-semibold mt-6 mb-3">Cookies</h2>
            <p className="mb-4 text-black">
            ...
            <h2 className="text-xl text-black font-semibold mt-6 mb-3">Third-Party Advertising</h2>
            <p className="mb-4 text-black">
            ...
            <h2 className="text-xl text-black font-semibold mt-6 mb-3">Your Data Protection Rights</h2>
            <p className="mb-4 text-black">
            ...
            <h2 className="text-xl text-black font-semibold mt-6 mb-3">Changes to This Privacy Policy</h2>
            <p className="mb-4 text-black">
              We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.
              You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.
            </p>
            
            <h2 className="text-xl text-black font-semibold mt-6 mb-3">Contact Us</h2>
            <p className="mb-4 text-black">
